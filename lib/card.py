...
class Card:
    def __init__(self):
        ...
        # 카드유형 공격, 스탯업그레이드
        self.CARD_TYPE_LIST = ("ATTACK", "STAT")
    ...
    def set_random_pool_value(self):
        value_scope = {}
        value_list = [(20, 40), (10, 20), (2, 4), (2, 4), (2, 5), (3, 4), (2, 3), (1, 2)]
        for name, value in zip(self.STATS_LIST + self.ATTACKS_LIST, value_list):
